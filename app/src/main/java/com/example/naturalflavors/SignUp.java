...
public class SignUp extends AppCompatActivity
{
                ...
                mAuth.createUserWithEmailAndPassword(signUpemail.getText().toString(), signUpPassword.getText().toString()).addOnCompleteListener(this, new OnCompleteListener<AuthResult>()
                {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        if(task.isSuccessful())
                        {
                            ...
                            setupUser(Core.fName, Core.lName, Core.salary);

                            Intent i = new Intent(signUpActivity, Expenses.class);
    ...
    public void setupUser(String fname, String lname, int salary)
    {
        ...
        if(user != null)
        {
            ...
            User customUser = new User(name, email, salary);
